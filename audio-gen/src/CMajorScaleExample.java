...
public class CMajorScaleExample implements JMC {
	
	public static void main(String[] args) {
		new CMajorScaleExample();
	}
	
	public CMajorScaleExample() {
